...
class AlgoliaIndexSettings extends AlgoliaSettings {
  ...
  })  : assert(indexName != '*', 'Index Name is required, but was found: $indexName'),
...
class AlgoliaSettings {
  ...
  AlgoliaSettings setDecompoundedAttributes(List<DecompoundedAttribute> value) {
    ...
    for (var attr in value) {
      list = Map<String, dynamic>.unmodifiable(Map<String, dynamic>.from(list)..addAll(attr.toMap()));
    }
    return _copyWithParameters(<String, dynamic>{'decompoundedAttributes': list});
  }
  ...
  AlgoliaSettings setkeepDiacriticsOnCharacters(String value) {
    ...
    return _copyWithParameters(<String, dynamic>{'keepDiacriticsOnCharacters': value});
  }
  ...
  ///
  AlgoliaSettings setDistinct({dynamic value = 0}) {
...
class DecompoundedAttribute {
  ...
  }) : assert(languageCode.length == 2, '`languageCode` must be 2-character language code');
